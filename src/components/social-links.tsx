...
export default function SocialLinks() {
  return (
    <div className="flex flex-row gap-3">
      <Link
        className="cursor-pointer transition-transform hover:scale-110 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary rounded"
