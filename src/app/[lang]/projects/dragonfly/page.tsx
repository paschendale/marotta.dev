    ...
    <div className="flex flex-col min-h-screen p-4 md:p-10 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col lg:flex-row p-4 gap-8 mt-4">
        <div className="flex flex-col w-full md:w-[30%]">
          ...
          <Image 
            src={images[0]} 
            alt="Dragonfly project main screenshot"
            width={600}
            height={400}
            sizes="(max-width: 1024px) 100vw, 600px"
            className="flex lg:hidden mt-7 rounded-lg shadow-md"
          />
          ...
          <div className="hidden lg:flex flex-col mt-7 gap-4">
            {images.map((e, i) => (
              <Image 
                key={i}
                src={e} 
                alt={`Dragonfly project screenshot ${i + 1}`}
                width={600}
                height={400}
        ...
        <div className="flex flex-col gap-6 w-full lg:w-[40%]">
          <h1 className="text-xl font-semibold">{intl["project-dragonfly"]}</h1>

          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-intro"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-dev"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-frontend"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-backend"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-mobile"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-contract"]}</p>
          
          <p className="text-foreground/90 leading-relaxed">{intl["project-dragonfly-deployment"]}</p>
        </div>
        <div className="flex flex-col w-full lg:w-[30%]">
          ...
          <Link 
            href="https://libelula.marotta.dev" 
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button 
